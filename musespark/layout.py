...
EXPERT_FAMILIES = ("gate_up_q", "gate_up_s", "down_q", "down_s")
...
def check_tp(cfg: Config, tp: int):
...
def rank_shapes(cfg: Config, tp: int = 8) -> dict[str, tuple[tuple[int, ...], np.dtype]]:
...
def bytes_per_rank(cfg: Config, tp: int = 8) -> dict[str, int]:
